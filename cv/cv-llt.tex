...
\geometry{top=1.3cm,bottom=1.3cm}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Leart Zuka}\\
  \newline
  \makefield{\aicon{\faEnvelope[regular]}{Email: }}{\href{mailto:leart.zuka@web.de}{\texttt{leart.zuka@web.de}}}
  \makefield{\aicon{\faPhone}{Phone: }}{\texttt{+49 174 4914284}}
  \makefield{\aicon{\faLinkedin}{LinkedIn: }}
  {\href{https://www.linkedin.com/in/leart-zuka-741092213/}{\texttt{LinkedIn}}}
\makefield{\aicon{\faGithub}{GitHub: }}
  {\href{https://github.com/leart-zuka/}{\texttt{Github}}}
\makefield{\aicon{\faGlobe}{Website: }}
  {\href{https://lzuka.tech}{\texttt{Website}}}
}
\rightheader{~}
%\begin{fullonly}
%\photo[r]{photo}
%\photoscale{0.20}
%\end{fullonly}\title{Curriculum Vitae}
